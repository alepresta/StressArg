Then /^verificar ingreso agente a ventanillas$/ do
  ...
  ############################################################################33
  esperar(1)
  titulo_home = capturar(:xpath , '/html/body/app-root/main/div')
  titulo_home = titulo_home.text
  if titulo_home.include? 'Seleccioná una ventanilla para atender'
    recepcion = capturar(:xpath, '/html/body/app-root/main/div/app-ventanilla/div/div/div/div[1]/div/h1')
    recepcion.click
    esperar(1)
    salir_de_ventanilla = capturar(:xpath, '/html/body/app-root/main/div/app-turnos/h1/button')
  ...
  esperar(1)
  pileta = capturar(:xpath, '/html/body/app-root/main/div/app-ventanilla/div/div/div/div[2]/div[5]/div/h1')
  pileta.click
  esperar(1)
  puts "Se valida que el usuario #{usuario}".yellow
  puts "Puede ingresar y,puede entrar o salir de la recepcion o cualquier otra ventanilla....[PASSED]".green
end

Then /^verificar acción de botón Devolver A Recepción$/ do
  pagina = 'https://qa-usuarios-turnos.argentina.gob.ar'
  go(pagina)
  usuario = "modagente_011@mailinator.com"
  password = "QAsnt2018"
  ...
  pileta.click
  esperar(1)
  llamar_al_siguiente_turno = capturar(:xpath, '/html/body/app-root/main/div/app-turnos-cola/div/div/button')
  llamar_al_siguiente_turno.click
  esperar(3)
  titulo = capturar(:class,'titulo-seccion').text
  titulo_que_deberia_estar = "ventanilla"
  if titulo.include? titulo_que_deberia_estar
    puts "NO SE ENCONTRARON TURNOS TOD VENTANILLA RECEPCIÓN (PILETA)".bold
  else
    ...
    while wixle == false
      ...
      puts "TURNOS ATENDIDOS PARA VACIAR (PILETA): #{nombre.yellow} #{apellido.yellow}  \t  CUIL:#{cuil.yellow}".bold
  ...
  titulo_home = titulo_home.text
  if titulo_home.include? 'Seleccioná una ventanilla para atender'
    visitante = capturar(:xpath, '/html/body/app-root/main/div/app-ventanilla/div/div/div/div[2]/div[1]/div/h1')
    visitante.click
    esperar(1)
    salir_de_ventanilla = capturar(:xpath, '/html/body/app-root/main/div/app-turnos-cola/h1/button')
    salir_de_ventanilla.click
  ...
  titulo_que_deberia_estar = "ventanilla"
  if titulo.include? titulo_que_deberia_estar
    puts "NO SE ENCONTRARON TURNOS TOD VENTANILLA PUERTA 01 (VISITANTE)".bold
  else
    wixle = titulo.include? titulo_que_deberia_estar
    while wixle == false
      terminado = capturar(:xpath, '/html/body/app-root/main/div/app-siguiente-turno/app-edicion-turno-form/div/form/div/div[2]/div[1]/button[3]')
      ...
      apellido = capturar(:xpath,'/html/body/app-root/main/div/app-siguiente-turno/app-edicion-turno-form/div/form/div/div[1]/div[2]/div/div[2]/p').text
      cuil = capturar(:xpath,'/html/body/app-root/main/div/app-siguiente-turno/app-edicion-turno-form/div/form/div/div[1]/div[2]/div/div[3]/p').text
      puts "TURNOS ATENDIDOS PARA VACIAR (VISITANTE): #{nombre.yellow} #{apellido.yellow}  \t  CUIL:#{cuil.yellow}".bold
      guardar = capturar(:xpath,'/html/body/app-root/main/div/app-siguiente-turno/app-edicion-turno-form/div/form/div/div[2]/div[2]/button')
      guardar.click
      esperar(1)
      llamar_siguiente_numero = capturar(:class, 'btn-primary')
  ...
  titulo_que_deberia_estar = "ventanilla"
  if titulo.include? titulo_que_deberia_estar
    puts "NO SE ENCONTRARON TURNOS TOD".bold
  else
    wixle = titulo.include? titulo_que_deberia_estar
    while wixle == false
      en_transcurso = capturar(:xpath, '/html/body/app-root/main/div/app-siguiente-turno/app-edicion-turno-form/div/form/div/div[2]/div[1]/button[2]')
      en_transcurso.click
      switch_si = capturar(:id, 'si')
      switch_si.click
      asignar_fila = capturar(:xpath, '/html/body/app-root/main/div/app-siguiente-turno/app-edicion-turno-form/div/form/div/div[2]/div[1]/div[3]/div/select/option[2]')
      asignar_fila.click
      guardar = capturar(:xpath,'/html/body/app-root/main/div/app-siguiente-turno/app-edicion-turno-form/div/form/div/div[2]/div[2]/button')
      guardar.click
      puts "TURNOS ASIGNADO A FILA 1 (VISITANTE): #{nombre.yellow} #{apellido.yellow}  \t  CUIL:#{cuil.yellow}".bold
      esperar(1)
      llamar_siguiente_numero = capturar(:class, 'btn-primary')
      llamar_siguiente_numero.click
      esperar(3)
  ...
  vivistante = capturar(:xpath , '/html/body/app-root/main/div/app-ventanilla/div/div/div/div[2]/div[1]/div')
  vivistante.click
  ...
  if titulo.include? titulo_que_deberia_estar
    ...
    wixle = titulo.include? titulo_que_deberia_estar
    while wixle == false
      devolver_a_recepcion = capturar(:xpath,'/html/body/app-root/main/div/app-siguiente-turno/app-edicion-turno-form/div/form/div/div[2]/div[1]/button[1]')
      devolver_a_recepcion
      guardar = capturar(:xpath,'/html/body/app-root/main/div/app-siguiente-turno/app-edicion-turno-form/div/form/div/div[2]/div[2]/button')
      guardar.click
      puts "TURNOS ASIGNADO A RECEPCIÓN (PILETA): #{nombre.yellow} #{apellido.yellow}  \t  CUIL:#{cuil.yellow}".bold
      esperar(1)
      llamar_siguiente_numero = capturar(:class, 'btn-primary')
      llamar_siguiente_numero.click
      esperar(3)
  ...
  esperar(1)
  ############################################################################
  puts "Se valida que se puede sacar turno por Tod y que el mismo se muestra en la ventanilla correspondiente"
  puts "Se valida el funcionamiento del botón DEVOLVER A RECEPCIÓN"
end

Then /^verificar acción de botón en transcurso$/ do
  puts "Se valida el funcionamiento del botón EN TRANSCURSO"
end

Then /^verificar se puede terminar de atendiender turnos$/ do
  pagina = 'https://qa-usuarios-turnos.argentina.gob.ar'
  go(pagina)
  usuario = "modagente_011@mailinator.com"
  password = "QAsnt2018"
